		...
		<>
			...
			<section className="category-brand-pg bg-[#F7F7F7] py-[40px] pb-[10%]">
				<div className="center-wr">
					...
					<div className="flex battery-pg-cont 320:flex-wrap">
						{/* sideform */}
              ...
              ">
						...
						<div className="320:w-full 1200:w-[69%]  brands-card-category-wr">
							<div className="w-[100%] 1440:mx-[30px]">
								<div style={{ borderRadius: "0 60px 60px 0" }} className="1200:bg-[#fff] 320:bg-transparent 320:border-none 1200:border-solid flex items-center justify-between py-[15px] mb-[20px] 1200:border-[#FF7637] 1200:border-[1px] w-[95%]">
								...
								<div className=''>
									<ul className="my-[10px] flex items-center flex-wrap justify-start gap-[25px] 320:mx-auto ">
