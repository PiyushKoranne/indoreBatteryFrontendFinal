	...
	return (
		<section className="freeToCallStripWr 320:hidden 1200:block absolute w-full top-0 translate-y-[-50%] left-[50%] translate-x-[-50%]">
			<div className="center-wr">
				<div className="bg-[#ff7637] text-[#fff] flex justify-evenly pb-[50px] pt-[50px] free-to-call-strip-content ">
					...
					<div className="feel-free-strip flex items-center justify-center gap-[20px]  w-fit max-w-[305px] ">
						...
						<div>
							...
							<h3 className="font-['Oswald] font-[600] text-white text-[18px] leading-[35px] uppercase mt-[5px] free-to-call-strip-links"><a target="_blank" href="https://maps.app.goo.gl/L1dzQkjN72dCWJTD9"> {contactDetails?.sectionContent?.filter(item => item?.elementAttrName === 'address')[0]?.elementValue}</a></h3>
						</div>
					...
					<div className="feel-free-strip flex items-center justify-center gap-[20px]  w-fit max-w-[345px] ">
						...
						<div>
							<span>Mail Us</span>
							<h3 className="font-['Oswald] font-[600] text-white text-[18px] leading-[35px] uppercase mt-[5px] free-to-call-strip-links"><a target="_blank" href="mailto:indorebattery@gmail.com"> {contactDetails?.sectionContent?.filter(item => item?.elementAttrName === 'email')[0]?.elementValue}</a></h3>
						</div>
