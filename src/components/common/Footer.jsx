			...
			<div className="center-wr">
				<div className="flex items-center flex-col">
					<h4 className="text-center py-[15px] font-sans font-[500] flex items-center flex-col">
						...
						<span className="cursive 320:text-[16px] text-[19px] text-[#989898] 320:tracking-wide 320:mt-[15px]">Crafted with <i className="fa-solid fa-heart text-rose-300 text-[13px]"></i> By <Link to="https://conativeitsolutions.com" className="320:text-[14px] 320:font-[500]"> &nbsp;Conative IT Solutions</Link></span>
					</h4>
				</div>
			</div>
		</footer>
