		...
		<>
			<div className="320:hidden 1024:block">
				<div className="new-header header-sticky-section">
					<div className="flex items-center p-[10px] 320:w-[90%] 2048:w-[80%] mx-auto my-0 relative">
						<Link to={"/"}>
							<figure>
						...
						<div className="flex items-center px-[30px] gap-[15px]">
							...
							>
								<a onClick={(e) => e.preventDefault()}>
									<Space>
										<p className="font-semibold text-[14px] cursor-pointer">Categories</p>
							...
							>
								<a onClick={(e) => e.preventDefault()}>
									<Space>
										<p className="font-semibold text-[14px] cursor-pointer">Brands</p>
										<PiCaretDownBold className="text-[#ff7637]" />
									</Space>
								</a>
							</Dropdown>
						...
						<div className="flex items-center absolute right-0">
							...
							<div className="w-[50px] h-[50px] flex items-center justify-center ">
								{
									loginStatus && loginStatus?.isLoggedIn ? (
										<Link to="/cart"><TbShoppingCartBolt className="text-[22px]" /></Link>
									) : (
										<Link to="/login"><TbShoppingCartBolt className="text-[22px]" /></Link>
									)
								}
					...
					<div className="flex items-center justify-start gap-[25px] 320:w-[90%] 2048:w-[80%] mx-auto my-0">
