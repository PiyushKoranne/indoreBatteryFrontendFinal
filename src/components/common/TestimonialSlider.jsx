...
function TestimonialSlider(){
    ...
    return(
        <div className="flex relative w-full items-center">
			<button onClick={()=>{swiperRef.current.slidePrev()}} className="w-[35px] h-[35px] bg-[#ff7637] text-white absolute transition-all hover:bg-[#000000] flex items-center justify-center left-[0px]"><img src="/images/swiperLefticon.png" alt="" /></button>
			<button onClick={()=>{swiperRef.current.slideNext()}} className="w-[35px] h-[35px] bg-[#ff7637] text-white absolute transition-all hover:bg-[#000000] flex items-center justify-center right-[0px]"><img src="/images/swiperRighticon.png" alt="" /></button>
			<Swiper
				spaceBetween={30}
